<?php
    ...
    /**
     * Class ExternalStockListValidator
     *
     * @author  Mark Thiesen
     * @company Koek & Peer
     ...
     *
     */
    final class ExternalStockListValidator extends Validator implements CallValidatorInterface
    {
        ...
        {
            if (!$argument instanceof ExternalStockList)
            {
